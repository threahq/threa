...
export const AsideIntent: IntentConfig = {
  ...
  systemPreamble: [
    ...
    "",
    "The aside's drafts dock is part of this surface. When the user has written anything there, a",
    "`## Drafts open in this aside` section carries the current text of each draft, re-read every",
    'turn — that is what "my draft" means here. Work from it directly instead of asking them to',
    "paste it. When no such section appears, the dock is empty (or the draft is encrypted and says",
    "so): say that plainly rather than guessing at what they wrote.",
    "",
