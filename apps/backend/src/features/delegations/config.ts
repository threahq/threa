 ...
 * (INV-33/44). The content caps live in `@threahq/types` — the `delegate_task`
 ...
 */
export { DELEGATION_TITLE_MAX_CHARS, DELEGATION_BRIEF_MAX_CHARS, DELEGATION_CONTEXT_REFS_MAX } from "@threahq/types"
