...
describe("StaticConfigResolver", () => {
  test("should resolve known component configs", async () => {
    ...
    expect(boundaryConfig.modelId).toBe("openrouter:openai/gpt-6-luna")
    ...
    expect(streamNamingConfig.modelId).toBe("openrouter:openai/gpt-6-luna")
    ...
    expect(memoClassifierConfig.modelId).toBe("openrouter:openai/gpt-6-luna")
    ...
    expect(memoMemorizerConfig.modelId).toBe("openrouter:openai/gpt-6-luna")
    ...
    expect(researcherConfig.modelId).toBe("openrouter:openai/gpt-6-luna")
