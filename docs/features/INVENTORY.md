...
| [link-previews](public/link-previews.md) ✅                                    | URL preview cards on messages                                                                                                                          | done                                                                           |
| [in-this-stream](public/in-this-stream.md) ✅                                  | Per-stream timeline of links, media, files, memories, and threads, derived live from loaded events; deep-links to origin                               | done                                                                           |
...
| [calls](calls.md) ✅ (M1, released)                                            | 1:1 DM voice/video via the Cloudflare Realtime SFU: header start, ring, docked call, timeline card, rejoin; `calls` feature flag (default on) + CF app | `features/calls`, `apps/frontend/src/calls`, `docs/plans/voice-video-calls.md` |
...
| [access-logging](architecture/access-logging.md) ✅           | Content-free audit trail: HTTP/socket/AI/auth capture, partitioned access_log + CP auth_log, boot coverage guard, breach-scoping queries | done                                                                                            |
| job-queue                                                     | PG-backed queue: fair-share scheduling, priorities, DLQ, the job-type catalog                                                            | `apps/backend/src/lib/queue/`                                                                   |
| ai-wrapper                                                    | `createAI` over the AI SDK and OpenRouter, cost tracking and budgets                                                                     | `packages/agent-runtime/src/ai/`                                                                |
