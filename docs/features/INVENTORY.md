...
| [persona-knowledge](public/persona-knowledge.md) ✅                            | Files attached to a custom/personal persona; extracted content injected as budgeted standing context, per-file context labels                   | `features/agents/persona-attachment-repository.ts`, `companion/prompt/persona-knowledge.ts` |
