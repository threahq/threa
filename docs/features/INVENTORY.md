...
| drafts                                                                         | Autosave, stashing, drafts page (the user-facing surface; cross-device roaming mechanics live in [architecture/remote-drafts](architecture/remote-drafts.md)) | `stores/draft-store.ts`, `pages/drafts.tsx`                                  |
...
| [remote-drafts](architecture/remote-drafts.md) ✅             | Centralized drafts that roam across devices: split-on-drift CAS, push/pull over the offline queue, resolve-on-send, thread re-pointing, E2E seal | done                                                                                            |
