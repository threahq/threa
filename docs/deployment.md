...
One PostHog project per region: EU workspaces report to the EU project (`POSTHOG_HOST=https://eu.i.posthog.com`), US workspaces to the US project (`https://us.i.posthog.com`). The control-plane is global and reports to the US project. Set both variables or neither: one without the other refuses to boot; neither in production boots with a single warning and error reporting disabled (INV-11).
...
| `POSTHOG_PROJECT_TOKEN`, `POSTHOG_HOST` | US PostHog project token + `https://us.i.posthog.com` — see the backend PostHog section                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
